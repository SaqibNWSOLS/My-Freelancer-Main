<template>
  <div class="text-center relative">
    <div @mouseover="openMenu" @mouseleave="closeMenu">
      ...
      <ul>
        <li class="py-2 px-4 cursor-pointer hover:bg-gray-100"><a href="profile">Manage Profile</a></li>
        <li class="py-2 px-4 cursor-pointer hover:bg-gray-100" @click="goToMyPage">View My Page</li>
        <li v-for="(item, index) in items" :key="index" :value="index" class="py-2 px-4 cursor-pointer hover:bg-gray-100">
          {{ item.title }}
        </li>
        <li class="py-2 px-4 cursor-pointer hover:bg-gray-100" @click="logoutUser">Log out</li>
      </ul>
    </div>
  </div>
    </div>
