      ...
      <div class="card lg:w-[50%]">
        <div class="card-header border-b-0">
          <div class="flex flex-col">
            <h3 class="text-lg font-medium">Create Job Category</h3>
          </div>
        </div>
        ...
        <div class="checkout-detail">
          <form @submit.prevent="submit" enctype="multipart/form-data">
            <div class="flex flex-col gap-3 form-group">
              ...
              <div class="md:w-[50%]" v-if="!form.parent_id">
...
export default {
  ...
  setup() {
    const form = useForm({
      ...
      icon: null,
      banner:null,
      iconPreview: 'https://atech-tc.com/wp-content/plugins/elementor/assets/images/placeholder.png',
      bannerPreview:'https://atech-tc.com/wp-content/plugins/elementor/assets/images/placeholder.png',
    });
    const fileName = ref('');
    ...
    function submit() {
      ...
      form.post(route('jobCategory.store'), {
        data: formData,
        headers: {
