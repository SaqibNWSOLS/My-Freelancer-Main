<template>
    <AdminLayout>
            ...
            <div>
                   <a  class="text-white btn btn-primary hover:-translate-y-1 hover:transition-all hover:ease-in-out" :href="route('cities.create')" style="float:right"><span class="mdi mdi-plus"></span> Add
</a>
            </div>
        </template>
                        ...
                        <table  ref="dataTable"  class="table equal-space head-table">
                            ...
                            <tbody>
                                <tr v-for="(city, index) in cities" :key="city.id">
                                    ...
                                    <td>
                                           <a :href="route('cities.edit', city.id)" lass="hover:-translate-y-1 hover:transition-all hover:ease-in-out" style="margin:10px"><span class="mdi mdi-database-edit text-lg text-[green]"></span></a>
                                        <button @click="deleteCity(city.id)" class="hover:-translate-y-1 hover:transition-all hover:ease-in-out"><span class="mdi  mdi-delete-empty-outline text-lg text-[red]"></span></button>
