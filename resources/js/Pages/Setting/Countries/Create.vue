...
<AdminLayout>
            ...
            <div class="card lg:w-[50%]">
                <div class="card-header border-b-0">
                    <div class="flex flex-col">
                        <h3 class="text-lg ">Create Country</h3>
                    </div>
                </div>         
  ...
  <div class="flex flex-col gap-3 form-group">
      <div class="flex flex-col gap-1"> 
          <label for="name" class="text-xs  text-primary">Country Name</label>
      ...
      <div class="flex flex-col gap-1"> 
          <label for="code" class="text-xs  text-primary">Code</label>
          <input v-model="form.code" id="code" type="text" class="p-[11px] dark:border-border-dark dark:bg-sidebar-dark2 w-full border border-border-light rounded-5 text-xs text-content"/>
      </div> 

      <label for="status" class="text-xs  text-primary">Status:</label>
      <div class="flex flex-col gap-3 form-group">
