            ...
            <div class="w-full md:w-1/2 bg-white p-10 flex flex-col gap-7">
                ...
                <form @submit.prevent="submit" novalidate class="flex flex-col gap-7">
                    ...
                    <div class="flex justify-around items-center gap-5">
                        ...
                        <div class="cursor-pointer bg-primary border text-center rounded-full p-2">
                            <i class="mdi mdi-facebook text-white text-lg"></i>
                        </div>
                        ...
                        <div class="cursor-pointer bg-white border text-center rounded-full p-2">
                            <i class="mdi mdi-google text-green-500 text-lg"></i>
                        </div>
                    </div>
                    <div class="flex items-center">
                        <hr class="flex-grow border-gray-300">
                    ...
                    <div class="flex justify-end flex-col md:flex-row">
                        <button type="submit" class="btn btn-primary text-lg bg-primary text-white py-2 px-4 rounded">Log in</button>
                    </div>
                </form>
